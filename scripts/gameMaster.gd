...
export var scenesList = ["res://scenes/maps/testChamber.tscn"] #this is the only scene
# 3D SKYBOX is also contained in testchamber
...
func updateSensitivity(newVal):
	mouse_sensitivity = newVal
	setSensitivity()
